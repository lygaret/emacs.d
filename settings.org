...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-c wH") 'split-window-horizontally)
  (global-set-key (kbd "C-c wL") (lambda () (interactive) (split-window-horizontally) (other-window 1)))
  (global-set-key (kbd "C-c wJ") (lambda () (interactive) (split-window-vertically) (other-window 1)))
  (global-set-key (kbd "C-c wK") 'split-window-vertically)
